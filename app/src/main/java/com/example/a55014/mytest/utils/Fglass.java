...
public class Fglass {
     ...
     */
    public static void blur(Context context, View fromView, ImageView toView, float radius, float scaleFactor) {
...
//        toView.setBackground(new BitmapDrawable(overlay));
        RequestOptions options = RequestOptions.bitmapTransform(new RoundedCorners(DeviceUtils.dip2px(context,
                10)));
        Glide.with(context).load(new BitmapDrawable(overlay)).apply(options).into(toView);
    }
