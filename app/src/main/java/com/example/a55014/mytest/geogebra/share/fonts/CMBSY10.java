...
import com.example.a55014.mytest.geogebra.share.Configuration;
import com.example.a55014.mytest.geogebra.share.FontInfo;

final class CMBSY10 extends FontInfo {

	CMBSY10(final String ttfPath) {
	...
	protected final void initMetrics() {
		...
		setInfo('\u00A2', // char code: 162
				new double[] { 0.319443, 0.47361, -0.02639, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00A6', // char code: 166
				new double[] { 0.574997, 0.47361, -0.02639, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00B0', // char code: 176
				new double[] { 1.149994, 0.694445, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00B3', // char code: 179
				new double[] { 0.89444, 0.502223, 0.002223, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00B5', // char code: 181
				new double[] { 0.89444, 0.696668, 0.196668, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00BC', // char code: 188
				new double[] { 0.89444, 0.524445, 0.024445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00BF', // char code: 191
				new double[] { 1.149994, 0.585556, 0.085556, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\"', // char code: 34
				new double[] { 0.574997, 0.694445, 0.194443, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0025', // char code: 37
				new double[] { 1.149994, 0.694445, 0.194443, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u002A', // char code: 42
				new double[] { 0.702774, 0.694445, 0.194443, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0030', // char code: 48
				new double[] { 0.344442, 0.555557, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0031', // char code: 49
				new double[] { 1.149994, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0032', // char code: 50
				new double[] { 0.766663, 0.585556, 0.085556, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0034', // char code: 52
				new double[] { 1.022217, 0.694445, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0037', // char code: 55
				new double[] { 0.0, 0.391111, -0.108889, 0. }, // metrics:
																// width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u003A', // char code: 58
				new double[] { 0.766663, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u003C', // char code: 60
				new double[] { 0.830551, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0040', // char code: 64
				new double[] { 0.702774, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0041', // char code: 65
				new double[] { 0.920728, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0030' }, // kern codes
				new double[] { 0.22361 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u0042', // char code: 66
				new double[] { 0.747844, 0.686111, 0., 0.02251 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0043', // char code: 67
				new double[] { 0.612982, 0.686111, 0., 0.047145 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0044', // char code: 68
				new double[] { 0.892079, 0.686111, 0., 0.031944 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0045', // char code: 69
				new double[] { 0.606941, 0.686111, 0., 0.082914 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0046', // char code: 70
				new double[] { 0.814089, 0.686111, 0., 0.101736 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0047', // char code: 71
				new double[] { 0.681595, 0.686111, 0.097223, 0.055736 }, // metrics:
																			// width,
																			// height,
																			// depth,
																			// italic
		...
		setInfo('\u0048', // char code: 72
				new double[] { 0.987389, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0030' }, // kern codes
		...
		setInfo('\u0049', // char code: 73
				new double[] { 0.64239, 0.686111, 0., 0.081415 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u004A', // char code: 74
				new double[] { 0.77944, 0.686111, 0.097223, 0.187502 }, // metrics:
																		// width,
																		// height,
																		// depth,
																		// italic
		...
		setInfo('\u004B', // char code: 75
				new double[] { 0.871249, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0030' }, // kern codes
		...
		setInfo('\u004C', // char code: 76
				new double[] { 0.78819, 0.686111, 0., 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				new char[] { '\u0030' }, // kern codes
		...
		setInfo('\u004D', // char code: 77
				new double[] { 1.377826, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0030' }, // kern codes
		...
		setInfo('\u004E', // char code: 78
				new double[] { 0.937322, 0.686111, 0., 0.152014 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u004F', // char code: 79
				new double[] { 0.905551, 0.686111, 0., 0.031944 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0050', // char code: 80
				new double[] { 0.809857, 0.686111, 0., 0.084582 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0051', // char code: 81
				new double[] { 0.939161, 0.686111, 0.097223, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0052', // char code: 82
				new double[] { 0.989576, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0030' }, // kern codes
		...
		setInfo('\u0053', // char code: 83
				new double[] { 0.696385, 0.686111, 0., 0.071289 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0054', // char code: 84
				new double[] { 0.644142, 0.686111, 0., 0.267362 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0055', // char code: 85
				new double[] { 0.714714, 0.686111, 0., 0.101736 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0056', // char code: 86
				new double[] { 0.737358, 0.686111, 0., 0.084582 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0057', // char code: 87
				new double[] { 1.168605, 0.686111, 0., 0.084582 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0058', // char code: 88
				new double[] { 0.816722, 0.686111, 0., 0.147024 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0059', // char code: 89
				new double[] { 0.758609, 0.686111, 0.097223, 0.084582 }, // metrics:
																			// width,
																			// height,
																			// depth,
																			// italic
		...
		setInfo('\u005A', // char code: 90
				new double[] { 0.818471, 0.686111, 0., 0.0813875 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u005B', // char code: 91
				new double[] { 0.766663, 0.555557, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0062', // char code: 98
				new double[] { 0.511108, 0.75, 0.25, 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u006D', // char code: 109
				new double[] { 0.702774, 0.75, 0.25, 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u006F', // char code: 111
				new double[] { 0.319443, 0.694445, 0.194443, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0070', // char code: 112
				new double[] { 0.958328, 0.06, 0.94, 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0073', // char code: 115
				new double[] { 0.56875, 0.694445, 0.194445, 0.127777 }, // metrics:
																		// width,
																		// height,
																		// depth,
																		// italic
		...
		setInfo('\u0078', // char code: 120
				new double[] { 0.526387, 0.694445, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0079', // char code: 121
				new double[] { 0.511108, 0.694445, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u007B', // char code: 123
				new double[] { 0.702774, 0.694445, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u007C', // char code: 124
				new double[] { 0.89444, 0.694445, 0.129629, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
