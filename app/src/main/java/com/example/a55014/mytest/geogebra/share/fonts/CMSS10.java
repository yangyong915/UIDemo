...
final class CMSS10 extends FontInfo {
	...
	protected final void initMetrics() {
		...
		setInfo('\u00A5', // char code: 165
				new double[] { 0.666669, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00A6', // char code: 166
				new double[] { 0.708338, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00AE', // char code: 174
				new double[] { 0.583336, 0.694445, 0., 0.069445 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00AF', // char code: 175
				new double[] { 0.536113, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00B1', // char code: 177
				new double[] { 0.813891, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00B4', // char code: 180
				new double[] { 0.266668, 0.444445, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00B7', // char code: 183
				new double[] { 0.500002, 0.631945, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00B9', // char code: 185
				new double[] { 0.500002, 0.608887, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00BC', // char code: 188
				new double[] { 0.480558, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00BD', // char code: 189
				new double[] { 0.722224, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00BE', // char code: 190
				new double[] { 0.777781, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00BF', // char code: 191
				new double[] { 0.500002, 0.541667, 0.097223, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00C0', // char code: 192
				new double[] { 0.8611145, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00C1', // char code: 193
				new double[] { 0.972226, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00C2', // char code: 194
				new double[] { 0.777781, 0.743055, 0.048612, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0021', // char code: 33
				new double[] { 0.319446, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				new char[] { '\u0060', '\u003C' }, // ligatures
				null, // kern codes
		...
		setInfo('\u0023', // char code: 35
				new double[] { 0.833336, 0.694445, 0.194443, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0025', // char code: 37
				new double[] { 0.833336, 0.75, 0.055555, 0. }, // metrics:
																// width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u0026', // char code: 38
				new double[] { 0.758336, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\'', // char code: 39
				new double[] { 0.277779, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				new char[] { '\'', '\"' }, // ligatures
				new char[] { '\u003F', '\u0021' }, // kern codes
		...
		setInfo('\u002A', // char code: 42
				new double[] { 0.500002, 0.75, 0., 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u002D', // char code: 45
				new double[] { 0.333334, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				new char[] { '\u002D', '\u007B' }, // ligatures
				null, // kern codes
		...
		setInfo('\u0030', // char code: 48
				new double[] { 0.500002, 0.655556, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u003A', // char code: 58
				new double[] { 0.277779, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u003B', // char code: 59
				new double[] { 0.277779, 0.444445, 0.125, 0. }, // metrics:
																// width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u003C', // char code: 60
				new double[] { 0.319446, 0.5, 0.194445, 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u003D', // char code: 61
				new double[] { 0.777781, 0.37, -0.13, 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0044', // char code: 68
				new double[] { 0.722226, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u0046', // char code: 70
				new double[] { 0.5694475, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u006F', '\u0065', '\u0075', '\u0072', '\u0061',
		...
		setInfo('\u0051', // char code: 81
				new double[] { 0.736113, 0.694445, 0.125, 0. }, // metrics:
																// width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u0055', // char code: 85
				new double[] { 0.687505, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0057', // char code: 87
				new double[] { 0.944448, 0.694445, 0., 0.013888 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0059', // char code: 89
				new double[] { 0.66667, 0.694445, 0., 0.025 }, // metrics:
																// width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u005B', // char code: 91
				new double[] { 0.28889, 0.75, 0.25, 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u005F', // char code: 95
				new double[] { 0.277779, 0.679365, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0066', // char code: 102
				new double[] { 0.305557, 0.694445, 0., 0.069445 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0067', // char code: 103
				new double[] { 0.500002, 0.444445, 0.194445, 0.013888 }, // metrics:
																			// width,
																			// height,
																			// depth,
																			// italic
		...
		setInfo('\u006B', // char code: 107
				new double[] { 0.488892, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u006C', // char code: 108
				new double[] { 0.23889, 0.694445, 0., 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u006D', // char code: 109
				new double[] { 0.794447, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0072', // char code: 114
				new double[] { 0.341669, 0.444445, 0., 0.013888 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0074', // char code: 116
				new double[] { 0.361112, 0.571431, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u0076', // char code: 118
				new double[] { 0.461113, 0.444445, 0., 0.013888 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0077', // char code: 119
				new double[] { 0.683336, 0.444445, 0., 0.013888 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u007A', // char code: 122
				new double[] { 0.434723, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u007B', // char code: 123
				new double[] { 0.500002, 0.444445, 0., 0.027779 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u007C', // char code: 124
				new double[] { 1.000003, 0.444445, 0., 0.027779 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u007E', // char code: 126
				new double[] { 0.500002, 0.676588, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00C4', // char code: 196
				new double[] { 0.500002, 0.679365, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
