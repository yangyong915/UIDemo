...
final class CMR10 extends FontInfo {
	...
	protected final void initMetrics() {
		...
		setInfo('\u00A5', // char code: 165
				new double[] { 0.666669, 0.683332, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00AE', // char code: 174
				new double[] { 0.583336, 0.694445, 0., 0.077779 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
				...
				new char[] { '\'', '\u003F', '\u0021', '\u0029', '\u005D' }, // kern
																				// codes
				new double[] { 0.077779, 0.077779, 0.077779, 0.077779,
						0.077779 }, // kern
									// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u00B4', // char code: 180
				new double[] { 0.305557, 0.430555, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00B7', // char code: 183
				new double[] { 0.500002, 0.628473, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00B9', // char code: 185
				new double[] { 0.500002, 0.567777, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00BA', // char code: 186
				new double[] { 0.750002, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00BC', // char code: 188
				new double[] { 0.500003, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00BD', // char code: 189
				new double[] { 0.722224, 0.430555, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00BF', // char code: 191
				new double[] { 0.500002, 0.527779, 0.097223, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00C0', // char code: 192
				new double[] { 0.902781, 0.683332, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00C1', // char code: 193
				new double[] { 1.013891, 0.683332, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00C2', // char code: 194
				new double[] { 0.777781, 0.731944, 0.048612, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u00C3', // char code: 195
				...
				new double[] { -0.277779, -0.319446 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u002D', // char code: 45
				new double[] { 0.333334, 0.430555, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				new char[] { '\u002D', '\u007B' }, // ligatures
				null, // kern codes
		...
		setInfo('\u003B', // char code: 59
				new double[] { 0.277779, 0.430555, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u003C', // char code: 60
				new double[] { 0.277779, 0.5, 0.194445, 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0046', // char code: 70
				new double[] { 0.652781, 0.683332, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u006F', '\u0065', '\u0075', '\u0072', '\u0061',
				...
				new double[] { -0.083334, -0.083334, -0.083334, -0.083334,
						-0.083334, -0.111112, -0.027779, -0.027779, -0.027779,
		...
		setInfo('\u0054', // char code: 84
				...
				new char[] { '\u0079', '\u0065', '\u006F', '\u0072', '\u0061',
						'\u0041', '\u0075' }, // kern
												// codes
				new double[] { -0.027779, -0.083334, -0.083334, -0.083334,
		...
		setInfo('\u0057', // char code: 87
				new double[] { 1.027781, 0.683332, 0., 0.013888 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0059', // char code: 89
				new double[] { 0.750002, 0.683332, 0., 0.025 }, // metrics:
																// width,
																// height,
																// depth, italic
				null, // ligatures
		...
		setInfo('\u0061', // char code: 97
				...
				new char[] { '\u0076', '\u006A', '\u0079', '\u0077' }, // kern
																		// codes
				new double[] { -0.027779, 0.055555, -0.027779, -0.027779 }, // kern
																			// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u0062', // char code: 98
				...
				new char[] { '\u0065', '\u006F', '\u0078', '\u0064', '\u0063',
						'\u0071', '\u0076', '\u006A', '\u0079', '\u0077' }, // kern
																			// codes
				new double[] { 0.027779, 0.027779, -0.027779, 0.027779,
						0.027779, 0.027779, -0.027779, 0.055555, -0.027779,
						-0.027779 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0066', // char code: 102
				new double[] { 0.305557, 0.694445, 0., 0.077779 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0067', // char code: 103
				new double[] { 0.500002, 0.430555, 0.194445, 0.013888 }, // metrics:
																			// width,
																			// height,
																			// depth,
																			// italic
		...
		setInfo('\u006B', // char code: 107
				new double[] { 0.527781, 0.694445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0061', '\u0065', '\u0061', '\u006F', '\u0063' }, // kern
																					// codes
				new double[] { -0.055555, -0.027779, -0.027779, -0.027779,
						-0.027779 }, // kern
										// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0071', // char code: 113
				new double[] { 0.527779, 0.430555, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0072', // char code: 114
				new double[] { 0.391668, 0.430555, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0074', // char code: 116
				new double[] { 0.38889, 0.61508, 0., 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
		...
		setInfo('\u0076', // char code: 118
				new double[] { 0.527781, 0.430555, 0., 0.013888 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0077', // char code: 119
				new double[] { 0.722224, 0.430555, 0., 0.013888 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u007B', // char code: 123
				new double[] { 0.500002, 0.430555, 0., 0.027779 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u007C', // char code: 124
				new double[] { 1.000003, 0.430555, 0., 0.027779 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u007E', // char code: 126
				new double[] { 0.500002, 0.667859, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00C5', // char code: 197
				new double[] { 0.27771, 0.018, 0.197, 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
