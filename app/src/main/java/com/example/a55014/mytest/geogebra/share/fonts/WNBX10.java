...
final class WNBX10 extends UniFontInfo {
	...
	WNBX10(final String ttfPath) {
		super(95, ttfPath, 0.444445, 0.383331, 1.149994, '\u0000');
	}

	@Override
	protected final void initMetrics() {
		setInfo('\u040A', // char code: 1034
				new double[] { 1.234021, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0416', '\u0425', '\u041E', '\u0424', '\u0472',
				...
				new double[] { -0.031944, -0.031944, -0.031944, -0.031944,
						-0.031944, -0.031944, -0.031944, -0.095833, -0.095833,
						-0.095833, -0.095833, -0.095833, -0.095833, -0.095833,
						-0.127777, -0.031944, -0.031944, -0.031944, -0.095833 }, // kern
																					// values
				null, '\0', // next larger
		...
		setInfo('\u040F', // char code: 1039
				new double[] { 0.901384, 0.686111, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u042D', // char code: 1069
				...
				new char[] { '\u0410', '\u0414', '\u0416', '\u0425', '\u0423',
						'\u0474', '\u042F' }, // kern
												// codes
				new double[] { -0.031944, -0.031944, -0.031944, -0.031944,
						-0.031944, -0.031944, -0.031944 }, // kern
															// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0402', // char code: 1026
				new double[] { 0.959717, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0416', '\u0425', '\u041E', '\u0424', '\u0472',
		...
		setInfo('\u040B', // char code: 1035
				new double[] { 0.8784685, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u045A', // char code: 1114
				new double[] { 0.86319, 0.444445, 0., 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				new char[] { '\u0443', '\u0475', '\u0442', '\u044A', '\u0463',
						'\u0447', '\u043E', '\u0473', '\u0444', '\u0454' }, // kern
																			// codes
				new double[] { -0.063889, -0.063889, -0.031944, -0.031944,
						-0.031944, -0.095833, -0.031944, -0.031944, -0.031944,
		...
		setInfo('\u045F', // char code: 1119
				new double[] { 0.6388855, 0.444445, 0.162038, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0454', // char code: 1108
				new double[] { 0.50472, 0.444445, 0., 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0452', // char code: 1106
				new double[] { 0.606941, 0.694445, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u042E', // char code: 1070
				new double[] { 1.273605, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0410', '\u0414', '\u0416', '\u0425', '\u0423',
		...
		setInfo('\u0416', // char code: 1046
				new double[] { 1.366656, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u041E', '\u0424', '\u0472', '\u0421', '\u0404',
						'\u0447', '\u0442', '\u044A', '\u0463' }, // kern
																	// codes
				new double[] { -0.031944, -0.031944, -0.031944, -0.031944,
						-0.031944, -0.031944, -0.031944, -0.031944, -0.031944 }, // kern
																					// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		setInfo('\u0419', // char code: 1049
				new double[] { 0.901384, 0.894394, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0401', // char code: 1025
				new double[] { 0.755551, 0.894394, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0474', // char code: 1140
				new double[] { 0.945828, 0.686111, 0., 0.015973 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
				...
				new char[] { '\u0410', '\u042F', '\u041E', '\u0424', '\u0472',
						...
						'\u044F' }, // kern
									// codes
				new double[] { -0.127777, -0.127777, -0.031944, -0.031944,
						-0.031944, -0.031944, -0.031944, -0.095833, -0.095833,
						-0.095833, -0.095833, -0.095833, -0.127777, -0.127777,
						-0.127777, -0.127777 }, // kern
												// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u044E', // char code: 1102
				new double[] { 0.862495, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0434', '\u0436', '\u0445', '\u044F' }, // kern
		...
		setInfo('\u0439', // char code: 1081
				new double[] { 0.6388855, 0.652727, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0451', // char code: 1105
				new double[] { 0.5270815, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0475', // char code: 1141
				new double[] { 0.685414, 0.444445, 0., 0.015973 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
				...
				new char[] { '\u0430', '\u043E', '\u0473', '\u0441', '\u0454',
						...
						'\u0459' }, // kern codes
				new double[] { -0.031944, -0.031944, -0.031944, -0.031944,
						-0.031944, -0.031944, -0.031944, -0.031944, -0.063889,
						-0.063889, -0.063889 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u044F', // char code: 1103
				new double[] { 0.6076355, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0308', // char code: 776
				new double[] { 0.574997, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0462', // char code: 1122
				new double[] { 0.945828, 0.75, 0., 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
				new char[] { '\u0416', '\u0425', '\u041E', '\u0424', '\u0472',
		...
		setInfo('\u0306', // char code: 774
				new double[] { 0.574997, 0.652727, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u00AB', // char code: 171
				new double[] { 0.6388855, 0.472223, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0410', // char code: 1040
				...
				new char[] { '\u041E', '\u0424', '\u0472', '\u0421', '\u0404',
						...
						'\u0463', '\u0447' }, // kern
												// codes
				new double[] { -0.031944, -0.031944, -0.031944, -0.031944,
						-0.031944, -0.095833, -0.095833, -0.095833, -0.095833,
						-0.095833, -0.095833, -0.095833, -0.127777, -0.031944,
						-0.031944, -0.031944, -0.095833 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0413', // char code: 1043
				...
				new char[] { '\u0410', '\u0414', '\u042F', '\u041B', '\u0409',
						...
						'\u0459', '\u044F' }, // kern
												// codes
				new double[] { -0.095833, -0.095833, -0.095833, -0.031944,
						-0.031944, -0.095833, -0.095833, -0.095833, -0.095833,
						-0.095833, -0.095833, -0.095833, -0.095833, -0.095833,
						-0.095833, -0.095833, -0.095833 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0420', // char code: 1056
				...
				new double[] { -0.095833, -0.095833, -0.095833, -0.095833,
						-0.095833, -0.031944, -0.031944, -0.031944, -0.031944,
						-0.031944, -0.095833, -0.095833, -0.095833 }, // kern
																		// values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0423', // char code: 1059
				...
				new char[] { '\u0410', '\u042F', '\u0414', '\u041B', '\u0409',
						...
						'\u0441', '\u0454', '\u0434', '\u043B', '\u0459',
						'\u044F' }, // kern codes
				new double[] { -0.095833, -0.095833, -0.063889, -0.063889,
						-0.063889, -0.031944, -0.031944, -0.031944, -0.031944,
						-0.031944, -0.095833, -0.095833, -0.095833, -0.095833,
						-0.095833, -0.095833, -0.095833, -0.095833, -0.095833,
		...
		setInfo('\u0429', // char code: 1065
				new double[] { 1.3312435, 0.686111, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0428', // char code: 1064
				new double[] { 1.3312435, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u042B', // char code: 1067
				new double[] { 1.124994, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u042A', // char code: 1066
				new double[] { 1.006938, 0.686111, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0416', '\u0425', '\u041E', '\u0424', '\u0472',
		...
		setInfo('\u0430', // char code: 1072
				...
				new double[] { -0.031944, -0.031944, -0.031944 }, // kern values
				null, '\0', // next larger
				null); // extension: top, mid, rep, bot
		...
		setInfo('\u0444', // char code: 1092
				new double[] { 0.89444, 0.694445, 0.194445, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0433', // char code: 1075
				new double[] { 0.49583, 0.444445, 0., 0. }, // metrics: width,
															// height, depth,
															// italic
				null, // ligatures
		...
		setInfo('\u0442', // char code: 1090
				new double[] { 0.544441, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0430', '\u0434', '\u043B', '\u0459', '\u044F' }, // kern
		...
		setInfo('\u0449', // char code: 1097
				new double[] { 0.941663, 0.444445, 0.162038, 0. }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u0448', // char code: 1096
				new double[] { 0.941663, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				null, // kern codes
		...
		setInfo('\u0437', // char code: 1079
				new double[] { 0.511108, 0.444445, 0., 0.006389 }, // metrics:
																	// width,
																	// height,
																	// depth,
																	// italic
		...
		setInfo('\u044A', // char code: 1098
				new double[] { 0.687495, 0.444445, 0., 0. }, // metrics: width,
																// height,
																// depth, italic
				null, // ligatures
				new char[] { '\u0443', '\u0475', '\u0442', '\u044A', '\u0463',
