...
import com.example.a55014.mytest.geogebra.share.platform.graphics.Stroke;
...
public class GraphicsStub implements Graphics2DInterface {
	...
	private Color color;
	private Font font;
	private List<com.example.a55014.mytest.geogebra.share.platform.graphics.stubs.AffineTransform> transformList = new ArrayList<com.example.a55014.mytest.geogebra.share.platform.graphics.stubs.AffineTransform>();
	private com.example.a55014.mytest.geogebra.share.platform.graphics.stubs.AffineTransform currentTransform;

	public GraphicsStub() {
		transformList = new ArrayList<com.example.a55014.mytest.geogebra.share.platform.graphics.stubs.AffineTransform>();
		reset();
	}

	public void reset() {
		transformList.clear();
		currentTransform = new com.example.a55014.mytest.geogebra.share.platform.graphics.stubs.AffineTransform();
		font = new FontStub();
		color = new ColorStub();
	...
	public void saveTransformation() {
		transformList
				.add((com.example.a55014.mytest.geogebra.share.platform.graphics.stubs.AffineTransform) currentTransform
						.createClone());
	}
