package com.example.a55014.mytest.game.util;
...
/**
 * @author yy
 * Create by 2019/12/23 10:22
 * to do 卡牌翻转视图帮助类
 */
public class RotatableHelper implements View.OnTouchListener {
    ...
    private RotatableHelper(Builder builder) {
